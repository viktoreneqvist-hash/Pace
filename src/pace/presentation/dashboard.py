...
def write_dashboard_html(*, state: AthleteState, trends: TrainingResponseTrends, plan: TrainingPlanFact | None, activities) -> Path:
    ...
    DASHBOARD_PATH.write_text(
        render_dashboard_html(state=state, trends=trends, plan=plan, activities=activities),
        encoding="utf-8",
    )
...
def render_dashboard_html(*, state: AthleteState, trends: TrainingResponseTrends, plan: TrainingPlanFact | None, activities) -> str:
